...
export const CurriculoProvider = ({ children }) => {
  const [textos, setTextos] = useState({
    ...
    projetos: [
      ...
      { id: 7, nome_do_projeto: "ERION SISTEMAS", descricao_do_projeto: "A ERION SISTEMAS está sendo o primeiro freela que consegui pela 99freelas em algum tempo. Está em desenvolvimento! ", link_do_projeto: "https://erionsistemas.vercel.app" },{ id: 8, nome_do_projeto: "Fórum ERION SISTEMAS", descricao_do_projeto: "Dei início recentemente a construção do fórum da Erion Sistemas. Está em desenvolvimento!", link_do_projeto: "https://forum-erion-sistemas.vercel.app" }
    ],
    experiencias: [
      {
